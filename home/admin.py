...
class AdminRating(admin.ModelAdmin):
    list_display=('book','user','book_rating','book_review','posted_date')
admin.site.register(Book_rating,AdminRating)


class AdminHighlight(admin.ModelAdmin):
    list_display=('user','book','highlight','is_public')

admin.site.register(Book_highlight,AdminHighlight)